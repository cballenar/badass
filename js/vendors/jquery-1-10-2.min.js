...
!function(window, undefined) {
    ...
    function internalData(elem, name, data, pvt) {
        if (jQuery.acceptData(elem)) {
            ...
            if (id && cache[id] && (pvt || cache[id].data) || data !== undefined || "string" != typeof name) // Only DOM nodes need a new unique ID for each element since their data
            ...
            return id || (id = isNode ? elem[internalKey] = core_deletedIds.pop() || jQuery.guid++ : internalKey), 
    ...
    function internalRemoveData(elem, name, pvt) {
        if (jQuery.acceptData(elem)) {
            ...
            if (cache[id]) {
                ...
                isNode ? jQuery.cleanData([ elem ], !0) : jQuery.support.deleteExpando || cache != cache.window ? /* jshint eqeqeq: true */
    ...
    function fixCloneNodeIssues(src, dest) {
        ...
        if (1 === dest.nodeType) {
            ...
            jQuery.support.html5Clone && src.innerHTML && !jQuery.trim(dest.innerHTML) && (dest.innerHTML = src.innerHTML)) : "input" === nodeName && manipulation_rcheckableType.test(src.type) ? (// IE6-8 fails to persist the checked state of a cloned checkbox
 ...
 */
        ...
        expando = "sizzle" + -new Date(), preferredDoc = window.document, dirruns = 0, done = 0, classCache = createCache(), tokenCache = createCache(), compilerCache = createCache(), hasDuplicate = !1, sortOrder = function(a, b) {
 ...
 */
    jQuery.Callbacks = function(options) {
        ...
        support.getSetAttribute = "t" !== div.className, // IE strips leading whitespace when .innerHTML is used
        ...
        support.hrefNormalized = "/a" === a.getAttribute("href"), // Make sure that element opacity exists
        ...
        support.boxSizingReliable = !0, // Make sure checked status is properly cloned
        ...
        support.checkClone = fragment.cloneNode(!0).cloneNode(!0).lastChild.checked, // Support: IE<9
        ...
        return support.ownLast = "0" !== i, jQuery(function() {
            ...
            tds[0].style.display = "", tds[1].style.display = "none", // Support: IE8
            ...
            typeof div.style.zoom !== core_strundefined && (// Support: IE<8
            // Check if natively block-level elements act like inline-block
            // elements when setting their display to 'inline' and giving
            // them layout
            div.innerHTML = "", div.style.cssText = divReset + "width:1px;padding:1px;display:inline;zoom:1", 
            support.inlineBlockNeedsLayout = 3 === div.offsetWidth, // Support: IE6
            // Check if elements with layout shrink-wrap their children
            div.style.display = "block", div.innerHTML = "<div></div>", div.firstChild.style.width = "5px", 
            support.shrinkWrapBlocks = 3 !== div.offsetWidth, support.inlineBlockNeedsLayout && (// Prevent IE 6 from affecting layout for positioned elements #11048
    ...
    jQuery.fn.extend({
        ...
        addClass: function(value) {
            ...
            classes = (value || "").match(core_rnotwhite) || []; len > i; i++) if (elem = this[i], 
        ...
        toggleClass: function(value, stateVal) {
            ...
            return "boolean" == typeof stateVal && "string" === type ? stateVal ? this.addClass(value) : this.removeClass(value) : this.each(jQuery.isFunction(value) ? function(i) {
                ...
                var className, i = 0, self = jQuery(this), classNames = value.match(core_rnotwhite) || []; className = classNames[i++]; ) // check each className given, space separated list
                self.hasClass(className) ? self.removeClass(className) : self.addClass(className); else (type === core_strundefined || "boolean" === type) && (this.className && // store className if set
        ...
        attr: function(elem, name, value) {
            ...
            return typeof elem.getAttribute === core_strundefined ? jQuery.prop(elem, name, value) : (1 === nType && jQuery.isXMLDoc(elem) || (name = name.toLowerCase(), 
    ...
    // http://msdn.microsoft.com/en-us/library/ms536429%28VS.85%29.aspx
    jQuery.support.hrefNormalized || // href/src property should get the full normalized URL (#10299/#12915)
 ...
 */
    jQuery.event = {
        ...
        remove: function(elem, types, handler, selector, mappedTypes) {
            ...
            if (elemData && (events = elemData.events)) {
                ...
                types = (types || "").match(core_rnotwhite) || [ "" ], t = types.length; t--; ) // Unbind all events (on this namespace, if provided) for the element
        ...
        handlers: function(event, handlers) {
            ...
            if (1 === cur.nodeType && (cur.disabled !== !0 || "click" !== event.type)) {
                ...
                sel = handleObj.selector + " ", matches[sel] === undefined && (matches[sel] = handleObj.needsContext ? jQuery(sel, this).index(cur) >= 0 : jQuery.find(sel, this, null, [ cur ]).length), 
        ...
        typeof elem[name] === core_strundefined && (elem[name] = null), elem.detachEvent(name, handle));
    ...
    jQuery.fn.extend({
        ...
        closest: function(selectors, context) {
            for (var cur, i = 0, l = this.length, ret = [], pos = rneedsContext.test(selectors) || "string" != typeof selectors ? jQuery(selectors, context || this.context) : 0; l > i; i++) for (cur = this[i]; cur && cur !== context; cur = cur.parentNode) // Always skip document fragments
    ...
    wrapMap.th = wrapMap.td, jQuery.fn.extend({
        ...
        replaceWith: function() {
            ...
            return this.domManip(arguments, function(elem) {
                ...
                parent && (// Don't use the snapshot next if it has moved (#13810)
                next && next.parentNode !== parent && (next = this.nextSibling), jQuery(this).remove(), 
        ...
        domManip: function(args, callback, allowIntersection) {
            ...
            first)) {
                ...
                rscriptType.test(node.type || "") && !jQuery._data(node, "globalEval") && jQuery.contains(doc, node) && (node.src ? // Hope ajax is available...
                jQuery._evalUrl(node.src) : jQuery.globalEval((node.text || node.textContent || node.innerHTML || "").replace(rcleanScript, "")));
        ...
        clone: function(elem, dataAndEvents, deepDataAndEvents) {
            ...
            fragmentDiv.removeChild(clone = fragmentDiv.firstChild)), !(jQuery.support.noCloneEvent && jQuery.support.noCloneChecked || 1 !== elem.nodeType && 11 !== elem.nodeType || jQuery.isXMLDoc(elem))) // Fix all IE cloning issues
        ...
        buildFragment: function(elems, context, scripts, selection) {
            ...
            if ("object" === jQuery.type(elem)) jQuery.merge(nodes, elem.nodeType ? [ elem ] : elem); else if (rhtml.test(elem)) {
                ...
                !jQuery.support.tbody) for (// String was a <table>, *may* have spurious <tbody>
    ...
    jQuery.fn.extend({
        ...
        style: function(elem, name, value, extra) {
            ...
            if (elem && 3 !== elem.nodeType && 8 !== elem.nodeType && elem.style) {
                ...
                hooks && "set" in hooks && (value = hooks.set(elem, value, extra)) === undefined))) // Wrapped to prevent IE from throwing errors when 'invalid' values are provided
                // Fixes bug #5509
                try {
                    style[name] = value;
                } catch (e) {}
    ...
    jQuery.each([ "ajaxStart", "ajaxStop", "ajaxComplete", "ajaxError", "ajaxSuccess", "ajaxSend" ], function(i, type) {
		...
		*/
        ...
        ajax: function(url, options) {
            ...
            s.data && (cacheURL = s.url += (ajax_rquery.test(cacheURL) ? "&" : "?") + s.data, 
    ...
    xhrSupported = jQuery.ajaxSettings.xhr(), jQuery.support.cors = !!xhrSupported && "withCredentials" in xhrSupported, 
        ...
        if (!s.crossDomain || jQuery.support.cors) {
            ...
            return {
                send: function(headers, complete) {
                    ...
                    setTimeout(callback) : (handle = ++xhrId, xhrOnUnloadAbort && (// Create the active xhrs callbacks list if needed
    ...
    jQuery.fx.step = {}, jQuery.expr && jQuery.expr.filters && (jQuery.expr.filters.animated = function(elem) {
        ...
        return docElem = doc.documentElement, jQuery.contains(docElem, elem) ? (typeof elem.getBoundingClientRect !== core_strundefined && (box = elem.getBoundingClientRect()), 
        win = getWindow(doc), {
    ...
    module.exports = jQuery : (// Otherwise expose jQuery to the global object as usual
